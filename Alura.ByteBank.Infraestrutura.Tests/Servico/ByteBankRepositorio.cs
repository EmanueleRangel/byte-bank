...
namespace Alura.ByteBank.Infraestrutura.Tests.Servico {
  public class ByteBankRepositorio : IByteBankRepositorio {
    ...
    public List<Agencia> Agencias { get; } = new List<Agencia>()
    {
            new Agencia()
            {
    ...
    public List<Agencia> BuscarAgencias() => this.Agencias;

    public List<Cliente> BuscarClientes() => this.Clientes;

    public List<ContaCorrente> BuscarContasCorrentes() => this.Contas;
  }
}
